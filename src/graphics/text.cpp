...
void Text::ensureGeometryUpdate() const
{
	...
	IntRect fontBounds = m_font->getGlyph(L'x', m_characterSize, bold).bounds;
    FloatRect xBounds = FloatRect(static_cast<float>(fontBounds.left),
								  static_cast<float>(fontBounds.top),
								  static_cast<float>(fontBounds.width),
								  static_cast<float>(fontBounds.height));
